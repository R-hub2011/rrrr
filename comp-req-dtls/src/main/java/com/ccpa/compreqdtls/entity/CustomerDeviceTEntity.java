...
@Entity
@Table(name = "CUSTOMER_DEVICE_T", schema = "CPP", catalog = "")
public class CustomerDeviceTEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(deviceId, manufacturerName, modelName, modelNumber, serialNumber, macAddress1, macAddress2, imei, iccid, id);
    }
}
