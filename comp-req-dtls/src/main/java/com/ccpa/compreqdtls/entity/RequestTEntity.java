...
@Entity
@Table(name = "REQUEST_T", schema = "CPP", catalog = "")
public class RequestTEntity {
    ...
    CustomerRequestTEntity cusRequestEntity;
    ...
    public CustomerRequestTEntity getCusRequestEntity() {
		return cusRequestEntity;
	}

	public void setCusRequestEntity(CustomerRequestTEntity cusRequestEntity) {
		this.cusRequestEntity = cusRequestEntity;
	}
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(requestId, that.requestId) &&
                ...
                Objects.equals(resiTnTypeCode, that.resiTnTypeCode) &&
                Objects.equals(resiEmail, that.resiEmail) &&
                ...
                Objects.equals(rqstrTnTypeCode, that.rqstrTnTypeCode) &&
                Objects.equals(rqstrEmail, that.rqstrEmail) &&
                Objects.equals(rqstrResiRelationCode, that.rqstrResiRelationCode);
    }

    @Override
    public int hashCode() {
        return Objects.hash(requestId, requestDatetime, resiNamePrefix, resiFirstName, resiMiddleName, resiLastName, resiNameSuffix, resiAddressLine1, resiAddressLine2, resiAddressCity, resiAddressState, resiPostalCode, resiAddressCountryCode, resiTnCountryCode, resiTnAreaCode, resiTnExchange, resiTnLineNumber, resiTnExtension, resiTnTypeCode, resiEmail, resiCustomerStatusCode, resiAuthenticationId, resiKbpPassFail, rqstrNamePrefix, rqstrFirstName, rqstrMiddleName, rqstrLastName, rqstrNameSuffix, rqstrAddressLine1, rqstrAddressLine2, rqstrAddressCity, rqstrAddressState, rqstrPostalCode, rqstrAddressCountryCode, rqstrTnCountryCode, rqstrTnAreaCode, rqstrTnExchange, rqstrTnLineNumber, rqstrTnExtension, rqstrTnTypeCode, rqstrEmail, rqstrResiRelationCode);
    }
}
